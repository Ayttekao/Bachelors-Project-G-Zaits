...
using Ayttekao.GraphBasedGenerator.Common;
using Ayttekao.GraphBasedGenerator.Grid2D;
using Ayttekao.Legacy.GeneralAlgorithms.Algorithms.Common;
...
namespace Ayttekao.Unity
{
    ...
    public static class RoomTemplateLoaderGrid2D
    {
        ...
        public static PolygonGrid2D GetPolygonFromTiles(HashSet<Vector3Int> allPoints)
        {
            ...
            var orderedDirections = new Dictionary<AyttekaoVector2Int, List<AyttekaoVector2Int>>
            {
                {IntVector2Helper.Top, new List<AyttekaoVector2Int> {IntVector2Helper.Left, IntVector2Helper.Top, IntVector2Helper.Right}},
                {IntVector2Helper.Right, new List<AyttekaoVector2Int> {IntVector2Helper.Top, IntVector2Helper.Right, IntVector2Helper.Bottom}},
                {IntVector2Helper.Bottom, new List<AyttekaoVector2Int> {IntVector2Helper.Right, IntVector2Helper.Bottom, IntVector2Helper.Left}},
                {IntVector2Helper.Left, new List<AyttekaoVector2Int> {IntVector2Helper.Bottom, IntVector2Helper.Left, IntVector2Helper.Top}}
            };
            ...
            var polygonPoints = new List<AyttekaoVector2Int>();
            ...
            while (true)
            {
                ...
                var currentDirection = new AyttekaoVector2Int();
        ...
        public static bool IsClockwiseOriented(IList<AyttekaoVector2Int> points)
        {
