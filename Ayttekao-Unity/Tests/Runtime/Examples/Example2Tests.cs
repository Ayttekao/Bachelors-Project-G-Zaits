...
using System.Linq;
using Ayttekao.Unity.Examples.Example2;
using UnityEditor;
using UnityEngine;
...
namespace Ayttekao.Unity.Tests.Runtime.Examples
{
    public class Example2Tests : ExampleTestsBase
    {
        ...
        public IEnumerator DifferentLevelGraphs()
        {
            ...
            {
                "Assets/Ayttekao/Examples/Grid2D/Example2/SimpleLevelGraph.asset",
                "Assets/Ayttekao/Examples/Grid2D/Example2/RealLifeLevelGraph.asset",
            };
