...
using System.Linq;
using Ayttekao.Unity.Examples.Example1;
using UnityEditor;
using UnityEngine;
using UnityEngine.Assertions;
using UnityEngine.TestTools;

namespace Ayttekao.Unity.Tests.Runtime.Examples
{
    public class Example1Tests : ExampleTestsBase
    {
        ...
        public IEnumerator DifferentLevelGraphs()
        {
            ...
            {
                "Assets/Ayttekao/Examples/Grid2D/Example1/SimpleLevelGraph.asset",
                "Assets/Ayttekao/Examples/Grid2D/Example1/RealLifeLevelGraph.asset",
            };
