...
namespace Ayttekao.Unity.Tests.Runtime.Meta
{
    public class AddComponentMenuTests
    {
        ...
        public void CheckCorrectMenuPath()
        {
            ...
            foreach (var component in components)
            {
                ...
                var expectedMenu = $"Ayttekao/{usedSuffix}/{splitByCamelCase} ({usedSuffix})";
                var expectedInternalMenu = $"Ayttekao/{usedSuffix}/_Internal/{splitByCamelCase} ({usedSuffix})";
