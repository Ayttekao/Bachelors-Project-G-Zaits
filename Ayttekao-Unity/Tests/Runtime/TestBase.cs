...
namespace Ayttekao.Unity.Tests
{
    public class TestBase : IPrebuildSetup, IPostBuildCleanup
    {
        private const string TestSceneFolder = "Assets/Ayttekao/Tests";
        private const string ExampleSceneFolder = "Assets/Ayttekao/Examples";
