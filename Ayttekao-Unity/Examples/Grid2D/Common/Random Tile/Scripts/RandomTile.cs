 ...
 *
 * An official fix will be released in the next "breaking" build of Ayttekao which means a build where the whole
...
namespace Ayttekao.Unity.Examples.Deprecated
{
    [Serializable]
