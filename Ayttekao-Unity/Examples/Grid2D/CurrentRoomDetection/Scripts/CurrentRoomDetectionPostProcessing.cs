...
namespace Ayttekao.Unity.Examples.CurrentRoomDetection
{
    [CreateAssetMenu(menuName = "Ayttekao/Examples/Current room detection/Post-processing", fileName = "CurrentRoomDetectionPostProcessing")]
