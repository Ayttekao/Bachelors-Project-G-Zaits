...
namespace Ayttekao.Unity.Editor
{
    public class RoomTemplateScreenshots
    {
        ...
        #if OndrejNepozitekAyttekao
        [MenuItem("Ayttekao debug/Room template screenshot with center %g")]
        public static void TakeScreenshotWithCenter()
        {
            TakeScreenshot(true);
        }

        [MenuItem("Ayttekao debug/Room template screenshot without center %h")]
        ...
        public static void TakeScreenshot(bool center)
        {
            ...
            var path =
                "C:\\Users\\ondra\\Projects\\JavaScript\\Ayttekao-Unity\\docs\\assets\\2d\\examples\\example2\\";
