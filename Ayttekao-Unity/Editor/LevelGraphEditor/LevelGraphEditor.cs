...
namespace Ayttekao.Unity.Editor
{
    public partial class LevelGraphEditor : EditorWindow
    {
        ...
        private bool snapToGrid => AyttekaoSettings.instance.General.SnapLevelGraphToGrid;
        ...
        private void DrawMenuBar()
        {
            ...
            {
                AyttekaoSettings.instance.General.SnapLevelGraphToGrid = snapToGridNewValue;
